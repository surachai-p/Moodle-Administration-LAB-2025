...
```
<img width="1278" height="428" alt="image" src="https://github.com/user-attachments/assets/0067f6e7-a4b4-4ff1-8bdb-7f2e39c2dd44" />
...
```
<img width="2720" height="644" alt="image" src="https://github.com/user-attachments/assets/b3bc8146-eeb2-4351-8e43-7357bf84fa0a" />
...
```
<img width="2164" height="154" alt="image" src="https://github.com/user-attachments/assets/25b07203-6e50-4cf3-9e0e-edf41c4bb28b" />
...
```
<img width="2902" height="764" alt="image" src="https://github.com/user-attachments/assets/61aecd24-bac2-4e64-9a20-d2b2138d956a" />
...
```
<img width="1928" height="796" alt="image" src="https://github.com/user-attachments/assets/6ace2d2d-ae48-4368-8927-d48f09ccaf7f" />
...
```
<img width="1378" height="473" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 10 56 08" src="https://github.com/user-attachments/assets/a9fbb510-bdb1-4897-9e47-08b4e933d4e4" />
...
```
<img width="948" height="496" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 11 13 48" src="https://github.com/user-attachments/assets/4ccb12fb-4d4a-411c-a7ef-d4e66837f526" />
...
```
<img width="947" height="702" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 11 14 44" src="https://github.com/user-attachments/assets/e2c86cb6-fd49-4eb3-bb20-7b20510cb614" />
...
```
<img width="932" height="777" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 11 39 21" src="https://github.com/user-attachments/assets/be63b1a2-0e55-4325-ae27-b65eecdb69f9" />
...
```
<img width="932" height="777" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 11 39 21" src="https://github.com/user-attachments/assets/f063f35f-3740-4b09-b42f-4b64616a9c9f" />
...
```
<img width="940" height="836" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 12 08 34" src="https://github.com/user-attachments/assets/12be46de-c1b1-474c-9076-0135244c1ed9" />
...
คำตอบ:
```
Image คือแม่แบบ, Container คือสิ่งที่รันจริงจาก Image
```
...
คำตอบ:
```
เชื่อม Container ให้สื่อสารกันผ่านชื่อ service
```
...
คำตอบ:
```
หมายถึงเชื่อม DB ผ่าน service db ไม่ใช้ localhost เพราะอยู่คนละ Container
```
...
คำตอบ:
```
Docker: ติดตั้งง่าย ยืดหยุ่น
ปกติ: ตั้งค่ายาก ใช้เวลานาน
```
...
วิธีแก้ไข:
ตรวจชื่อ service และ environment variables
```
...
คำตอบ:
```
Container และข้อมูลใน Volume ถูกลบทั้งหมด
```
