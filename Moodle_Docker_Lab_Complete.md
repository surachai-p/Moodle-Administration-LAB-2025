...
<img width="1920" height="1020" alt="Screenshot 2026-02-06 145113" src="https://github.com/user-attachments/assets/fd390d3a-c73f-4790-8562-b1b80c54c236" />
<img width="1920" height="1020" alt="Screenshot 2026-02-06 145123" src="https://github.com/user-attachments/assets/07751f7e-8a6d-476b-ba49-6c9cfbe64817" />
...
**บันทึกผลการทดลอง 2:**
<img width="1920" height="1020" alt="Screenshot 2026-02-06 145243" src="https://github.com/user-attachments/assets/e5918765-4211-417b-8035-9ced9d5ef495" />
...
**บันทึกผลการทดลอง 3:**
<img width="1920" height="1020" alt="Screenshot 2026-02-06 145436" src="https://github.com/user-attachments/assets/c94de81a-3bac-43b0-8ad9-89c7d11523ca" />
...
```
**บันทึกผลการทดลอง 4:**
<img width="1920" height="1020" alt="Screenshot 2026-02-06 145644" src="https://github.com/user-attachments/assets/b81f1402-38c9-459d-917f-9b16768e5dd6" />
...
**บันทึกผลการทดลอง 5:**
<img width="1920" height="1020" alt="Screenshot 2026-02-06 145927" src="https://github.com/user-attachments/assets/04c05d30-a86f-4eaa-882a-717a4fe28f64" />
<img width="1920" height="1020" alt="Screenshot 2026-02-06 145944" src="https://github.com/user-attachments/assets/432bab8a-7309-45c5-93fe-ee0548798729" />
...
**บันทึกผลการทดลอง 6:**
<img width="1920" height="1020" alt="Screenshot 2026-02-06 153922" src="https://github.com/user-attachments/assets/9170dd93-b10a-457d-87c7-cba26f00819e" />
...
<img width="1920" height="1020" alt="Screenshot 2026-02-13 142216" src="https://github.com/user-attachments/assets/3f8697cf-6281-4902-af47-b74f58fee3b4" />
...
**บันทึกผลการทดลอง 7:**
<img width="1920" height="1020" alt="Screenshot 2026-02-17 150642" src="https://github.com/user-attachments/assets/427669bc-5df1-4695-b795-83f9425bfb1d" />
...
**บันทึกผลการทดลอง 8:**
<img width="1920" height="1020" alt="Screenshot 2026-02-17 221339" src="https://github.com/user-attachments/assets/bd27262d-cb9b-4802-aee3-0663c27a8452" />
...
**บันทึกผลการทดลอง 9:**
<img width="1920" height="1020" alt="Screenshot 2026-02-17 222119" src="https://github.com/user-attachments/assets/9c1c1796-0b71-4531-83c8-e3504d3db3f1" />
...
**บันทึกผลการทดลอง 10:**
<img width="1920" height="1020" alt="Screenshot 2026-02-17 230425" src="https://github.com/user-attachments/assets/0c9c81ee-d3c0-4402-9663-e6ef1b2d5b4a" />
...
5. 
   **บันทึกผลการทดลอง 11:**
<img width="1920" height="1020" alt="Screenshot 2026-02-17 232527" src="https://github.com/user-attachments/assets/301ee1b9-376a-42ae-ab3b-dbc2d74ef9c4" />
<img width="1920" height="1020" alt="Screenshot 2026-02-17 233250" src="https://github.com/user-attachments/assets/2c4298a7-e215-46a0-9239-f228da306d2a" />
<img width="1920" height="1020" alt="Screenshot 2026-02-17 233234" src="https://github.com/user-attachments/assets/b7b35372-f28b-4558-8d3f-e2a502c46977" />
...
คำตอบ:
```
Docker Image คือ "แม่พิมพ์" หรือเทมเพลตที่อ่านได้อย่างเดียว (Read-only) บรรจุซอฟต์แวร์และการตั้งค่าพื้นฐานไว้ ส่วน Docker 
Container คือ "สิ่งที่ถูกสร้างขึ้น" จาก Image เพื่อนำไปรันจริง (Instance) ซึ่งสามารถเขียนข้อมูลทับได้
```
...
คำตอบ:
```
มีทั้งหมด 2 ตัว ได้แก่:
moodle_app: ทำหน้าที่เป็น Web Server (Apache) และตัวประมวลผลภาษา PHP เพื่อแสดงหน้าเว็บไซต์ Moodle
moodle_db: ทำหน้าที่เป็น Database Server (MariaDB) สำหรับจัดเก็บข้อมูลโครงสร้าง เว็บไซต์ ผู้ใช้งาน และคะแนนต่าง ๆ
```
...
คำตอบ:
```
เป็นแบบ Named Volume (ชื่อ db_data และ moodledata)
ข้อดี: ข้อมูลไม่หายเมื่อลบ Container, Docker จัดการพื้นที่ให้เองอัตโนมัติ, ย้ายข้อมูลหรือสำรองข้อมูลได้ง่าย
ข้อเสีย: เข้าถึงไฟล์จากฝั่ง Host Machine โดยตรงได้ยากกว่าแบบ Bind Mount (เพราะไฟล์ถูกเก็บไว้ในพื้นที่จัดการของ Docker)
```
...
คำตอบ:
```
ทำหน้าที่เป็นสะพานเชื่อมต่อเสมือน (Virtual Bridge) ให้ Container สื่อสารกันได้ภายในวงเดียวกัน
โดยสื่อสารกันผ่าน Container Name (เช่น Moodle จะมองหา DB ผ่านชื่อโฮสต์ว่า db)แทนการใช้เลข IP Address ที่อาจเปลี่ยนแปลงได้
```
...
คำตอบ:
```
ใช้กำหนด ลำดับการทำงาน ของ Container โดยระบุว่า moodle จะเริ่มทำงานได้ก็ต่อเมื่อ db ถูกสร้างและเริ่มทำงานก่อน
เพื่อป้องกันปัญหา Moodle รันขึ้นมาแล้วหาฐานข้อมูลไม่เจอ
```
...
คำตอบ:
```
แก้ไขที่หัวข้อ ports: ใน service moodle จากเดิม - "80:80" เป็น - "9000:80" (ฝั่งซ้ายคือพอร์ตของเครื่อง Host ที่เราต้องการเปลี่ยน)
```
...
คำตอบ:
```
หมายถึงการบอกให้ Moodle เชื่อมต่อไปยัง Database ที่ชื่อ Service ว่า db สาเหตุที่ไม่ใช้ localhost เพราะในโลกของ Docker นั้น localhost ของ
Container moodle_app หมายถึงตัวมันเอง ไม่ใช่เครื่องคอมพิวเตอร์หลักหรือ Container ตัวอื่น จึงต้องระบุชื่อ Service เพื่อให้ Docker Network ช่วยค้นหาให้
```
...
คำตอบ:
```
ข้อดีของ Docker: ติดตั้งเร็วมาก (ไม่กี่นาที), ตัดปัญหาเรื่อง Version ของ PHP/Database ไม่ตรงกับเครื่อง, ย้ายระบบไปเครื่องอื่นได้ทันทีโดยไม่ต้องตั้งค่าใหม่
ข้อเสียของ Docker: ต้องเรียนรู้คำสั่ง Docker เพิ่มเติม, กินทรัพยากรเครื่องมากกว่าการลงแบบ Native เล็กน้อย (เนื่องจากต้องรัน Docker Engine)
```
...
คำตอบ:
```
วิธีตรวจสอบ: ใช้คำสั่ง docker-compose ps เพื่อดูว่า moodle_db มีสถานะเป็น Up หรือไม่ และใช้ docker-compose logs db เพื่อดูว่าฐานข้อมูลทำงานปกติไหม
วิธีแก้ไข: ตรวจสอบรหัสผ่านใน MYSQL_PASSWORD และ MOODLE_DB_PASSWORD ว่าตรงกันหรือไม่ และเช็คชื่อ MOODLE_DB_HOST ว่าพิมพ์ชื่อ Service ถูกต้องหรือไม่
```
...
คำตอบ:
```
ข้อมูลจะหายไปทั้งหมด เพราะคำสั่ง -v จะลบทั้ง Container, Network และ Volumes (ฐานข้อมูลและไฟล์ที่เด็กส่งงานมาจะถูกลบทิ้งถาวร)
```
