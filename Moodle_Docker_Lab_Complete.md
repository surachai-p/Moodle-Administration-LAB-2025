...
**บันทึกผลการทดลอง 1:**
<img width="870" height="536" alt="image" src="https://github.com/user-attachments/assets/576848c3-ecf1-408a-879f-5b5e8c6adb5d" />
...
**บันทึกผลการทดลอง 2:**
<img width="780" height="136" alt="image" src="https://github.com/user-attachments/assets/fd9b74cb-e2dd-48c9-8cb9-a86d30fa09ef" />
...
**บันทึกผลการทดลอง 5:**
<img width="1087" height="531" alt="image" src="https://github.com/user-attachments/assets/0d2146c2-7ee9-42c3-a4e1-91ff225de94a" />
...
**บันทึกผลการทดลอง 6:**
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/59729d73-8f94-4275-ad28-c1755e4d7f75" />
...
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/8c6b1413-8309-4e52-822e-3fd4cc26f1f0" />
...
**บันทึกผลการทดลอง 7:**
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/3d8d48b5-3873-48ac-949e-017452b34b27" />
...
**บันทึกผลการทดลอง 8:**
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/7f4aac35-21e2-4bb3-87f2-8777ccd78961" />
...
**บันทึกผลการทดลอง 9:**
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/4a3544f2-fb0d-494e-9255-68dd393940da" />
...
**บันทึกผลการทดลอง 10:**
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/31e48bf0-b381-467a-9f5f-cf8a57e28995" />
...
5. 
   **บันทึกผลการทดลอง 11:**
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/99e036d7-e828-43b1-af8d-a6f28a3dfa07" />
...
คำตอบ:
```
1.มี Container 3 ตัว
2.moodle_app เป็นส่วนของ "หน้าบ้าน" และ "ตัวประมวลผลหลัก" ทำหน้าที่รับคำสั่ง แสดงผลหน้าเว็บ และประมวลผลคำสั่งต่างๆ จากผู้ใช้งาน
  moodle_db เป็นส่วนของ "คลังข้อมูล" ทำหน้าที่ระบบจัดการฐานข้อมูล
  moodle-docker เป็น "ตู้คอนเทนเนอร์ใบใหญ่" ทำหน้าที่จัดกลุ่มให้ moodle_app และ moodle_db อยู่ในเน็ตเวิร์กเดียวกัน
```
...
คำตอบ:
```
1.มีการจัดการ Volume แบบ Named Volume
2.ข้อดี: ประสิทธิภาพสูง (Performance) Docker จัดการให้ทั้งหมด (Ease of Management)
  ความปลอดภัยของข้อมูล (Data Persistence) รองรับ Volume Drivers
  ข้อเสีย: เข้าถึงไฟล์จากข้างนอกยาก (Isolation) เปลืองพื้นที่ดิสก์ (Disk Space) 
```
