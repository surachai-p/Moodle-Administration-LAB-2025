...
<img width="606" height="87" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 13 59 13" src="https://github.com/user-attachments/assets/73d46f2e-a7f2-4504-a31e-f9f1fc5d2f61" />
...
<img width="1367" height="127" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 14 21 54" src="https://github.com/user-attachments/assets/706a7382-7cba-46f2-abea-52f1ba75786c" />
...
<img width="1140" height="87" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 14 22 57" src="https://github.com/user-attachments/assets/5dd7be63-2e15-4ee5-9300-67736e1039a5" />
...
<img width="1144" height="37" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 14 25 54" src="https://github.com/user-attachments/assets/dbefe9d2-0f6f-4d76-b73b-966b3639630c" />
<img width="349" height="25" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 14 26 15" src="https://github.com/user-attachments/assets/978e83ef-06ee-4f82-8d06-35f94b615afc" />
...
<img width="907" height="472" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 14 27 56" src="https://github.com/user-attachments/assets/5546a01e-6c28-47c5-a27f-1f197a6fe08e" />
...
**บันทึกผลการทดลอง 6:**
<img width="1434" height="900" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 14 43 26" src="https://github.com/user-attachments/assets/a8d535f4-4349-488d-a1b6-536b4a4b46f2" />
...
<img width="1438" height="813" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 15 07 56" src="https://github.com/user-attachments/assets/ba69856c-6681-4c8a-9c72-2881e9e32744" />
...
<img width="1440" height="811" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 15 21 28" src="https://github.com/user-attachments/assets/e4122afc-096c-44e2-a713-a28e26c7a4e3" />
...
**บันทึกผลการทดลอง 8:**
<img width="1440" height="813" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 15 37 43" src="https://github.com/user-attachments/assets/8cd3d9fb-ae44-4615-93ac-15b0d27518c6" />
...
<img width="1397" height="242" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 15 41 35" src="https://github.com/user-attachments/assets/5a8f1adb-e2b5-4424-a6ce-ea729e1afdab" />
...
<img width="1403" height="514" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 15 47 39" src="https://github.com/user-attachments/assets/b1530c59-e396-41f1-8886-d33c57ef1c88" />
...
<img width="1430" height="799" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 16 18 22" src="https://github.com/user-attachments/assets/fc91fce9-fd86-45cb-a6d2-81a97e92c4e0" />

<img width="1433" height="614" alt="ภาพถ่ายหน้าจอ 2569-02-06 เวลา 16 30 15" src="https://github.com/user-attachments/assets/4d65d7dd-a4a8-4611-9bae-980324a8d713" />
...
คำตอบ:
```
  Docker Image คือเทมเพลตของซอฟต์แวร์ที่ใช้สำหรับสร้าง Docker Container โดย Docker Image เป็นแบบ อ่านอย่างเดียว (Read-only) ไม่สามารถเปลี่ยนแปลงได้โดยตรง และสามารถนำไปใช้สร้าง Container ได้หลายตัว
  Docker Container คืออินสแตนซ์ที่ถูกรันขึ้นมาจาก Docker Image สามารถอ่านและเขียนข้อมูลได้ (Read–Write) เมื่อ Container ถูกหยุดหรือลบ ข้อมูลภายในจะหายไป เว้นแต่จะมีการจัดเก็บผ่าน Docker Volume เเละเป็นเครื่องมือจัดการ Multi-containerเเละจัดการหลาย Container พร้อมกัน
```
...
คำตอบ:
```
มี 2 ตัว moodle_db เเละ moodle_app
  moodle_db เป็น Docker Container ที่ทำหน้าที่เป็น ระบบฐานข้อมูล (Database Server) ของ Moodle โดยใช้ MariaDB สำหรับจัดเก็บข้อมูลสำคัญทั้งหมดของระบบ เช่น ข้อมูลผู้ใช้งาน รายวิชา เนื้อหาบทเรียน คะแนน ผลการทำกิจกรรม และการตั้งค่าต่าง ๆ ของระบบ ข้อมูลจะถูกเก็บแบบถาวรผ่าน Docker Volume ชื่อ db_data เพื่อให้ข้อมูลยังคงอยู่แม้มีการหยุดหรือลบ Container
  moodle_app เป็น Docker Container ที่ทำหน้าที่เป็น ระบบแอปพลิเคชันและเว็บเซิร์ฟเวอร์ของ Moodle LMS ทำหน้าที่ให้บริการเว็บไซต์แก่ผู้ใช้งานผ่าน Web Browser ประมวลผลคำสั่งด้วย PHP และติดต่อกับฐานข้อมูลใน Container moodle_db ผ่าน Docker Network เพื่อดึงและบันทึกข้อมูล นอกจากนี้ยังจัดเก็บไฟล์ที่ผู้ใช้งานอัปโหลด 
```
...
คำตอบ:
```
  จากการทดลองมีการจัดการข้อมูลด้วย Docker Volume แบบ Named Volume โดยกำหนด Volume ชื่อ db_data สำหรับจัดเก็บข้อมูลฐานข้อมูลของ MariaDB และ Volume ชื่อ moodledata สำหรับจัดเก็บไฟล์ข้อมูลของ Moodle LMS ซึ่งเป็นการแยกข้อมูลออกจากตัว Container โดยตรง

ข้อดีของ Named Volume
	- ข้อมูลยังคงอยู่แม้จะมีการหยุดหรือลบ Container
	- ช่วยแยกการทำงานระหว่างระบบแอปพลิเคชันกับข้อมูลออกจากกัน
	- สามารถสำรอง (Backup) และกู้คืน (Restore) ข้อมูลได้ง่าย
	- รองรับการใช้งานซ้ำเมื่อมีการสร้าง Container ใหม่

ข้อเสียของ Named Volume
	- ไม่สามารถมองเห็นหรือแก้ไขไฟล์ข้อมูลได้โดยตรงจากเครื่อง Host อย่างสะดวก
	- ต้องใช้คำสั่ง Docker เพิ่มเติมในการตรวจสอบหรือจัดการ Volume
	- หากลบ Volume ด้วยคำสั่ง docker-compose down -v ข้อมูลทั้งหมดจะสูญหาย
```
...
คำตอบ:
```
  Network ใน Docker Compose ทำหน้าที่เป็นเครือข่ายเสมือนสำหรับเชื่อมต่อ Container ต่าง ๆ ให้สามารถสื่อสารกันได้อย่างปลอดภัย โดยในการทดลองนี้ใช้ Bridge Network ซึ่งทำให้ Container สามารถติดต่อกันได้ผ่าน ชื่อ Container หรือชื่อ Service แทนการใช้ IP Address เช่น Container moodle_app สามารถเชื่อมต่อไปยัง Container moodle_db ได้ผ่าน hostname db บนพอร์ต 3306
```
...
คำตอบ:
```
  depends_on ใช้กำหนดลำดับการเริ่มต้นของ Container เพื่อให้ Container ที่จำเป็นต้องใช้งานก่อนถูกเริ่มต้นก่อน ในการทดลองนี้ moodle_app ถูกกำหนดให้ขึ้นกับ db เพื่อให้ระบบฐานข้อมูลเริ่มทำงานก่อน Moodle ลดปัญหาการเชื่อมต่อฐานข้อมูลไม่สำเร็จในช่วงเริ่มต้นระบบ
```
...
คำตอบ:
```
ตรงไฟล์ docker-compose.yml ที่   moodle:
ที่
  ports:
    - "80:80"
```
...
คำตอบ:
```
  MOODLE_DB_HOST=db หมายถึงการกำหนดให้ Moodle เชื่อมต่อฐานข้อมูลโดยใช้ ชื่อ service (db) ซึ่งเป็น hostname ภายใน Docker Network ที่ Docker Compose สร้างให้โดยอัตโนมัติ การไม่ใช้ localhost เนื่องจาก localhost ภายใน Container จะอ้างถึงตัว Container เอง ไม่ใช่ Container ฐานข้อมูล ทำให้ไม่สามารถเชื่อมต่อ MariaDB ที่อยู่คนละ Container ได้
```
...
คำตอบ:
```
ข้อดีของการติดตั้งด้วย Docker
	- ติดตั้งและเริ่มใช้งานได้รวดเร็ว
	- แยกสภาพแวดล้อมของระบบออกจากเครื่อง Host
	- ลดปัญหาความแตกต่างของระบบปฏิบัติการ
	- ง่ายต่อการย้ายระบบและสำรองข้อมูล

ข้อเสียของการติดตั้งด้วย Docker
	- ต้องมีความรู้พื้นฐานด้าน Docker
  - การ debug บางกรณีซับซ้อนกว่าการติดตั้งปกติ
	- ใช้ทรัพยากรเพิ่มจากการทำ Containerization

การติดตั้งแบบปกติ
	- เหมาะกับผู้ที่ไม่คุ้นเคย Docker
	- ควบคุมระบบโดยตรงได้ง่าย
	- แต่ใช้เวลาติดตั้งนาน และเสี่ยงต่อปัญหาความเข้ากันของซอฟต์แวร์
``` 
...
```
วิธีตรวจสอบ:
  - ตรวจสอบว่า container moodle_db กำลังรันอยู่ด้วย docker-compose ps
  - ตรวจสอบ log ของ moodle_app ด้วย docker-compose logs moodle
  - ตรวจสอบค่า Environment Variables ที่เกี่ยวข้องกับ Database
  - ตรวจสอบ Docker Network ว่า Container อยู่ใน network เดียวกัน
  
วิธีแก้ไข:
  - รีสตาร์ท container ด้วย docker-compose restart
  - แก้ไขค่า username, password หรือ database name ให้ตรงกัน
  - ตรวจสอบว่า MOODLE_DB_HOST ใช้ชื่อ service db ถูกต้อง
  - ตรวจสอบว่า MariaDB เปิดใช้งานและพอร์ต 3306 ทำงานปกติ
...
คำตอบ:
```
  คำสั่ง docker-compose down -v จะหยุดและลบ Container, Network และ Docker Volume ทั้งหมด ที่กำหนดไว้ ทำให้ข้อมูลใน Volume เช่น ฐานข้อมูล MariaDB และไฟล์ Moodle ถูกลบออกทั้งหมดและไม่สามารถกู้คืนได้ เว้นแต่จะมีการสำรองข้อมูลไว้ก่อน
```
