...
<img width="1919" height="881" alt="image" src="https://github.com/user-attachments/assets/e38811a5-3c8c-4e35-9fa6-eb7f27d70b0d" />

<img width="1918" height="874" alt="image" src="https://github.com/user-attachments/assets/9976d17f-e7d6-47f1-b3fa-dde93730f7f9" />
...
1.moodle_app: ทำหน้าที่เป็น Web Server (เช่น Apache/Nginx) และประมวลผลโค้ด PHP ของ Moodle
2.moodle_db: ทำหน้าที่เป็น Database Server (เช่น MySQL/MariaDB) สำหรับจัดเก็บฐานข้อมูลตัวอักษรทั้งหมด
```
